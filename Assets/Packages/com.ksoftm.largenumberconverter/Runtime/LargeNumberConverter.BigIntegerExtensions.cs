namespace Ksoftm.LargeNumberConverter
{
  ...
  public static partial class LargeNumberConverter
  {
    ...
    public static BigInteger Sqrt(this BigInteger n)
    {
      ...
      BigInteger x = BigInteger.One << (bitLength / 2);
    ...
    /// <summary>
    /// Converts a numeric value (int, long, etc.) directly to BigInteger.
    /// </summary>
    ...
    /// </summary>
    public static string ToShortForm(this BigInteger value)
        => LargeNumberConverter.ToShortString(value);

    /// <summary>
    /// Formats BigInteger into "illion" text form.
    /// </summary>
    public static string ToIllionForm(this BigInteger value)
        => LargeNumberConverter.ToIllionText(value);
    #endregion
    ...
    /// </summary>
    public static BigInteger ParseWithSuffix(this string input)
        => LargeNumberConverter.Parse(input);
    ...
    {
      var sum = inputWithSuffix.Add(toAdd);
      return LargeNumberConverter.ToIllionText(sum);
    }
    ...
    public static bool TryParseWithSuffix(this string input, out BigInteger result)
    {
      ...
      try
      {
        decimal scaled = number * (decimal)BigInteger.Pow(10, exponent);
